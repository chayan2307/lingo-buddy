...
location = ['Camden', 'Islington', 'Hackney', 'Kensington', 'Tower Hamlets', 'Richmond', 'Finsbury Park', 'Westminster', 'Brent', 'Ealing', 'Greenwich' ]
...
User.create(languages: languages.sample, location: location.sample, email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://i.pinimg.com/originals/97/ed/6b/97ed6b370803649addbf66144c18c194.png")
