...
User.create(bio: bio.sample, languages: languages.sample, location: "Westgrove Lane,  Greenwich, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://cdn.shopify.com/s/files/1/1944/0163/files/portrait-of-man-casual-hairstyle.jpg?v=1588112735")
User.create(bio: bio.sample, languages: languages.sample, location: "Lambeth Walk, Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://stylesatlife.com/wp-content/uploads/2021/07/Hairstyles-for-Men-over-50-Years.jpg")
User.create(bio: bio.sample, languages: languages.sample, location: "Winfrith Road, Wandsworth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "http://d279m997dpfwgl.cloudfront.net/wp/2020/07/Emmanuel-1000x776.jpg")
User.create(bio: bio.sample, languages: languages.sample, location: "North End Road, Fulham, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://media.istockphoto.com/photos/mature-african-man-portrait-picture-id180816724?k=20&m=180816724&s=612x612&w=0&h=GzhYNa9LcuyTBVtejayD5mniWgC7iAaIzn1iXG79KSI=")
User.create(bio: bio.sample, languages: languages.sample, location: "Knivet Road, Fulham, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://media.istockphoto.com/photos/portrait-of-a-taiwanese-man-picture-id1149504274?k=20&m=1149504274&s=612x612&w=0&h=3yLf9OAkYZ0hB_ezday1W-xpn_o_yjMCo7hX8rBwf4o=")
User.create(bio: bio.sample, languages: languages.sample, location: "Horsford Road,  Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.pond5.com/hispanic-man-city-smile-happy-088159156_prevstill.jpeg")
User.create(bio: bio.sample, languages: languages.sample, location: "Trent Road,  Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://photos.spareroom.com/images/flatshare/listings/large/20/01/200103922.jpg")
