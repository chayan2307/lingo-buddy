...
User.create(bio: bio, languages: languages.sample, location: "Bowland Road,  Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://t4.ftcdn.net/jpg/02/18/71/87/360_F_218718766_Pc3cFwBDSUqZtWUuBv2utZazq1joM5Eb.jpg")
User.create(bio: bio, languages: languages.sample, location: "Edgeley Lane,  Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.unsplash.com/photo-1530785602389-07594beb8b73?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8aGFwcHklMjBhZnJpY2FuJTIwd29tYW58ZW58MHx8MHx8&w=1000&q=80")
User.create(bio: bio, languages: languages.sample, location: "Margate Road,  Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.female_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://image1.masterfile.com/getImage/NjAwLTAwOTQ4NjcxZW4uMDAwMDAwMDA=AL2-ZR/600-00948671en_Masterfile.jpg")
...
User.create(bio: bio, languages: languages.sample, location: "Horsford Road,  Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://images.pond5.com/hispanic-man-city-smile-happy-088159156_prevstill.jpeg")
User.create(bio: bio, languages: languages.sample, location: "Trent Road,  Lambeth, London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://photos.spareroom.com/images/flatshare/listings/large/20/01/200103922.jpg")
User.create(bio: bio, languages: languages.sample, location: "Blake's Road,  Southwark , London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://i.pinimg.com/736x/f4/80/a8/f480a84bc0836f4b68cb9f8028343c83--rasta-tattoo-dreadlocks.jpg")
User.create(bio: bio, languages: languages.sample, location: "Furley Road,  Southwark , London", email: Faker::Internet.email, rate: 10, first_name: Faker::Name.male_first_name, last_name: Faker::Name.last_name, password: "123456", teacher: true, photo_url: "https://www.realmenrealstyle.com/wp-content/uploads/2021/06/man-20s-style.jpg")
